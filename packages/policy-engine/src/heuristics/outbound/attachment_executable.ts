...
// Near-decisive on outbound — there's essentially no legitimate reason
// for our platform to ship an .exe attachment.
export const attachmentExecutable: Heuristic = (input) => {
  ...
  return {
    ...
    score: -20,
    evidence: `Outbound executable attachment: ${filenameHit ?? mimeHit}`,
  };
};
