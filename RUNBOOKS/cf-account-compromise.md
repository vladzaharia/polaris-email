...
1. Rotate every secret (every API key, IMAP password, webhook secret, `POLARIS_SECRET_A`, anchor signing key, forensic master key — for forensic, derive v2 and re-wrap rows). All emergency-mode.
