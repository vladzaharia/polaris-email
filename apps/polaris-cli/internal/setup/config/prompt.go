...
func Prompt(initial *Config, opts PromptOptions) (*Config, error) {
	...
	tail := []step{
		...
		{key: "ANCHOR_S3_ENDPOINT", desc: "Anchor S3 endpoint URL", val: &c.AnchorS3Endpoint,
			def: defaultIfBlank(c.AnchorS3Endpoint, "https://s3.us-west-005.backblazeb2.com"), valid: optionalURL},
		{key: "ANCHOR_S3_BUCKET", desc: "Anchor S3 bucket (Object Lock COMPLIANCE)", val: &c.AnchorS3Bucket,
			def: defaultIfBlank(c.AnchorS3Bucket, "polaris-anchors")},
		{key: "ANCHOR_S3_REGION", desc: "Anchor S3 region (e.g. us-west-005)", val: &c.AnchorS3Region,
			def: defaultIfBlank(c.AnchorS3Region, "us-west-005")},
		{key: "ANCHOR_S3_ACCESS_KEY_ID", desc: "Anchor S3 application key ID (optional)", val: &c.AnchorS3AccessKeyID},
		{key: "ANCHOR_S3_SECRET_ACCESS_KEY", desc: "Anchor S3 application key secret (optional)", val: &c.AnchorS3SecretAccessKey},
