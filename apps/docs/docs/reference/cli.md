...
See the [Operators](/operators) section for the workflows that use these
verbs (Day-2 → CLI tour) and the runbooks for incident-response
procedures (both land in later batches).

<!-- Verified against: docs/cli.md @ 022520fd49a135eaf4685a09668439d58257ec95 -->
