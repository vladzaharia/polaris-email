---
title: Audit anchor maintenance
description: Detection and recovery for the hourly audit-anchor cron — transient B2 outages, signing-key rotation, B2 credential exhaustion, and chain verification. The off-Cloudflare integrity fence.
sidebar_label: Anchor maintenance
sidebar_position: 2
---
...
Documented in the [threat model](/security/threat-model). Two reasons:
...
model with the security review checklist in the
[threat model](/security/threat-model).

<!-- Verified against: docs/runbooks/anchor-maintenance.md @ c3c1b5048dd5bfe92facdce24982141a07446042 -->
