// Messages list view — filters → GET /v1/messages.
//
...
//
// This view renders WITHOUT outer page chrome — the caller decides whether
// to wrap in `<PageCard>` (the standalone /messages route) or a section
// card (the domain detail page's Activity tab).
...
export interface MessagesListViewProps {
  // Optional implicit domain scope. When set, every query carries
  // `?domain=<id>` so the list shows messages for mailboxes attached to
