// Admin API-key management surface. Rotate/revoke invalidate the previous
// secret immediately; the panel gates them client-side via
// `DestructiveActionDialog`. The audit_log chain records who did what.
