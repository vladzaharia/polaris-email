// vitest config for @polaris-mail/in.
//
// Two projects:
//   * `in-workers` — pool-workers project for Worker handler integration
//     tests (loaded from `vitest.workers.config.ts`).
//   * `in-unit`    — plain Node project for everything else, excluding
